...
var selection_handler: EditorSelection
...
var create_i: int = 0
var toolbar_menu: GoshapeMenus.GSMenu
...
func _enter_tree() -> void:
	...
	selection_handler = editor.get_selection()
...
func _exit_tree() -> void:
	if selection_handler and selection_handler.selection_changed.is_connected(_on_selection_changed):
