@tool
@icon("res://addons/gpu_texture_painter/icons/camera_brush_icon.svg")
...
@export var brush_shape: Texture2D = preload("res://addons/gpu_texture_painter/brush_shapes/smooth_brush_shape.exr"):
	set(value):
		brush_shape = value
...
func _ready() -> void:
	...
	var camera_brush_scene: PackedScene = load("res://addons/gpu_texture_painter/brush/camera_brush_viewport.tscn")
